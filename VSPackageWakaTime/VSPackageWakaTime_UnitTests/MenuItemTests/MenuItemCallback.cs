...
using Wakatime.VSPackageWakaTime;

namespace VSPackageWakaTime_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new VSPackageWakaTimePackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Wakatime.VSPackageWakaTime.GuidList.guidVSPackageWakaTimeCmdSet, (int)Wakatime.VSPackageWakaTime.PkgCmdIDList.cmdidUpdateAppKey);
