...
namespace VSPackageWakaTime_IntegrationTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Wakatime.VSPackageWakaTime.GuidList.guidVSPackageWakaTimeCmdSet, (int)Wakatime.VSPackageWakaTime.PkgCmdIDList.cmdidUpdateAppKey);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "VSPackageWakaTime", "Wakatime.VSPackageWakaTime.VSPackageWakaTimePackage");
